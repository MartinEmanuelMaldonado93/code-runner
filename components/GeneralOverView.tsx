		...
		<div className='mx-8'>
			<article className='prose w-full max-w-3xl flex flex-col items-center mt-6'>
				...
				<p className='max-w-2xl'>
					Using a web platform that runs code can be a
					valuable tool when preparing for software
					engineering interviews. <br /> These platforms
					allow you to practice coding challenges and
					problems in an environment that simulates the
					actual coding experience, with real-time feedback
